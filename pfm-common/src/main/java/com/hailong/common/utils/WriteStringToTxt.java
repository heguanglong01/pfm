...
public class WriteStringToTxt {
    ...
    public static void WriteStringToFile2(String filePath,String value) {
        try {
            FileWriter fw = new FileWriter(filePath, true);
            BufferedWriter bw = new BufferedWriter(fw);
            bw.write(value);// 往已有的文件上添加字符串
            bw.close();
            fw.close();
        } catch (Exception e) {
            // TODO Auto-generated catch block
...
//        String filePath = "E:\\link.txt";
        // new WriteStringToTxt().WriteStringToFile(filePath);
         new WriteStringToTxt().WriteStringToFile2("D:/opt/filedata1.txt","dddddddddddd");
